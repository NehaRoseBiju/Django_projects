...
(function () {
  ...
  onReady(function () {
    ...
    function initUserProfile() {
        var user = window.adminHMDUser || { name: "Admin Hasan", workspace: "Active Workspace", avatar: "/static/images/avatar.png" };
        ...
        Array.prototype.forEach.call(profileNameEls, function (el) { el.textContent = el.textContent || user.name; });
        Array.prototype.forEach.call(profileAvatarEls, function (img) { if (user.avatar) img.src = user.avatar; if (user.name) img.alt = img.alt || user.name; });
    }
